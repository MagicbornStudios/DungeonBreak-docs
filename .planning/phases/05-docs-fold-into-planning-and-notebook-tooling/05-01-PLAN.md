...
must_haves:
  ...
  artifacts:
    - path: ".planning/phases/05-docs-fold-into-planning-and-notebook-tooling/05-01-SUMMARY.md"
      provides: "Execution summary for plan 01"
      min_lines: 10
  key_links:
    - from: ".planning/ROADMAP.md"
      to: ".planning/phases/05-docs-fold-into-planning-and-notebook-tooling/05-01-SUMMARY.md"
