...
must_haves:
  ...
  artifacts:
    - path: ".planning/phases/06-lab-setup-uv-lab-command-and-notebook-improvements/06-01-SUMMARY.md"
      provides: "Execution summary for plan 01"
      min_lines: 10
  key_links:
    - from: ".planning/ROADMAP.md"
      to: ".planning/phases/06-lab-setup-uv-lab-command-and-notebook-improvements/06-01-SUMMARY.md"
