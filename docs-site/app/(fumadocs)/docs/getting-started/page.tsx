			...
			<DocsBody>
				<div className="fd-prose">
					...
					<ul>
						...
						<li>
							<Link href="/docs/content-delivery-system">Content Delivery System</Link> - E2E workflow across content authoring, Supabase delivery, Unreal plugin import, and Dolt lineage role.
						</li>
					</ul>
					<p>
						Run <code>npm run lab</code> (or at least <code>npm run docs:generate</code>) so that docs are generated and up to date.
					</p>
				</div>
			</DocsBody>
		</DocsPage>
