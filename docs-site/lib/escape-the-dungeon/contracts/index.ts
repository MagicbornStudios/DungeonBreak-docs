import { z } from "zod";
import actionCatalogJson from "@/lib/escape-the-dungeon/contracts/data/action-catalog.json";
import actionFormulasJson from "@/lib/escape-the-dungeon/contracts/data/action-formulas.json";
import cutscenesJson from "@/lib/escape-the-dungeon/contracts/data/cutscenes.json";
import itemsJson from "@/lib/escape-the-dungeon/contracts/data/items.json";
import roomTemplatesJson from "@/lib/escape-the-dungeon/contracts/data/room-templates.json";
import skillsJson from "@/lib/escape-the-dungeon/contracts/data/skills.json";
