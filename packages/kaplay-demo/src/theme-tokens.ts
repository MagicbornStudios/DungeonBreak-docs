...
export const uiPalette = {
  ...
  headerSubtitle: [219, 188, 149] as const,
  textPrimary: [245, 237, 220] as const,
  textMuted: [199, 181, 156] as const,
...
export const feedToneColor = {
  ...
  narrator: [226, 206, 186] as const,
  plain: [204, 191, 174] as const,
};
