...
//
//     ContentSource data = nlohmann::json::parse(jsonString);
...
namespace DungeonBreakContracts {
    ...
    class FeatureProfileClass {
        public:
        FeatureProfileClass() = default;
        virtual ~FeatureProfileClass() = default;
    ...
    class VectorProfileClass {
        public:
        VectorProfileClass() = default;
        virtual ~VectorProfileClass() = default;
    ...
    class Archetype {
        ...
        std::string description;
        FeatureProfileClass feature_profile;
        std::string label;
        std::vector<std::string> preferred_skills;
        VectorProfileClass vector_profile;
        ...
        const FeatureProfileClass & get_feature_profile() const { return feature_profile; }
        FeatureProfileClass & get_mutable_feature_profile() { return feature_profile; }
        void set_feature_profile(const FeatureProfileClass & value) { this->feature_profile = value; }
        ...
        const VectorProfileClass & get_vector_profile() const { return vector_profile; }
        VectorProfileClass & get_mutable_vector_profile() { return vector_profile; }
        void set_vector_profile(const VectorProfileClass & value) { this->vector_profile = value; }
    ...
    class Room {
        ...
        private:
        VectorProfileClass base_vector;
        int64_t column;
        std::string description;
        ...
        public:
        const VectorProfileClass & get_base_vector() const { return base_vector; }
        VectorProfileClass & get_mutable_base_vector() { return base_vector; }
        void set_base_vector(const VectorProfileClass & value) { this->base_vector = value; }
    ...
    class Skill {
        ...
        FeatureProfileClass feature_bonus;
        std::string name;
        boost::optional<bool> requires_rune_forge;
        std::string skill_id;
        VectorProfileClass trait_bonus;
        ...
        const FeatureProfileClass & get_feature_bonus() const { return feature_bonus; }
        FeatureProfileClass & get_mutable_feature_bonus() { return feature_bonus; }
        void set_feature_bonus(const FeatureProfileClass & value) { this->feature_bonus = value; }
        ...
        const VectorProfileClass & get_trait_bonus() const { return trait_bonus; }
        VectorProfileClass & get_mutable_trait_bonus() { return trait_bonus; }
        void set_trait_bonus(const VectorProfileClass & value) { this->trait_bonus = value; }
    ...
    class ContentFeature {
        ...
        const VectorProfileClass & get_traits() const { return traits; }
        VectorProfileClass & get_mutable_traits() { return traits; }
        void set_traits(const VectorProfileClass & value) { this->traits = value; }
    };
    ...
    class PowerFeature {
        ...
        const FeatureProfileClass & get_traits() const { return traits; }
        FeatureProfileClass & get_mutable_traits() { return traits; }
        void set_traits(const FeatureProfileClass & value) { this->traits = value; }
    };
    ...
    class VectorRuntime {
        public:
        VectorRuntime() = default;
        virtual ~VectorRuntime() = default;
    ...
    class ContentSource {
        ...
        const Packs & get_packs() const { return packs; }
        Packs & get_mutable_packs() { return packs; }
        void set_packs(const Packs & value) { this->packs = value; }

        const std::string & get_schema_version() const { return schema_version; }
        std::string & get_mutable_schema_version() { return schema_version; }
        void set_schema_version(const std::string & value) { this->schema_version = value; }

        const VectorRuntime & get_vector_runtime() const { return vector_runtime; }
        VectorRuntime & get_mutable_vector_runtime() { return vector_runtime; }
        void set_vector_runtime(const VectorRuntime & value) { this->vector_runtime = value; }
    };
}
...
namespace DungeonBreakContracts {
    ...
    void from_json(const json & j, FeatureProfileClass & x);
    void to_json(json & j, const FeatureProfileClass & x);

    void from_json(const json & j, VectorProfileClass & x);
    void to_json(json & j, const VectorProfileClass & x);
    ...
    void from_json(const json & j, VectorRuntime & x);
    void to_json(json & j, const VectorRuntime & x);
    ...
    inline void from_json(const json & j, FeatureProfileClass& x) {
    ...
    inline void to_json(json & j, const FeatureProfileClass & x) {
        j = json::object();
        j["Awareness"] = x.get_awareness();
    ...
    inline void from_json(const json & j, VectorProfileClass& x) {
    ...
    inline void to_json(json & j, const VectorProfileClass & x) {
        j = json::object();
        j["Comprehension"] = x.get_comprehension();
        j["Constraint"] = x.get_constraint();
    ...
    inline void from_json(const json & j, Archetype& x) {
        ...
        x.set_description(j.at("description").get<std::string>());
        x.set_feature_profile(j.at("featureProfile").get<FeatureProfileClass>());
        x.set_label(j.at("label").get<std::string>());
        x.set_preferred_skills(j.at("preferredSkills").get<std::vector<std::string>>());
        x.set_vector_profile(j.at("vectorProfile").get<VectorProfileClass>());
    ...
    inline void from_json(const json & j, Room& x) {
        x.set_base_vector(j.at("baseVector").get<VectorProfileClass>());
    ...
    inline void from_json(const json & j, Skill& x) {
        ...
        x.set_feature_bonus(j.at("featureBonus").get<FeatureProfileClass>());
        x.set_name(j.at("name").get<std::string>());
        x.set_requires_rune_forge(get_stack_optional<bool>(j, "requiresRuneForge"));
        x.set_skill_id(j.at("skillId").get<std::string>());
        x.set_trait_bonus(j.at("traitBonus").get<VectorProfileClass>());
    ...
    inline void from_json(const json & j, ContentFeature& x) {
        ...
        x.set_description(j.at("description").get<std::string>());
        x.set_label(j.at("label").get<std::string>());
        x.set_traits(j.at("traits").get<VectorProfileClass>());
    }
    ...
    inline void from_json(const json & j, PowerFeature& x) {
        ...
        x.set_description(j.at("description").get<std::string>());
        x.set_label(j.at("label").get<std::string>());
        x.set_traits(j.at("traits").get<FeatureProfileClass>());
    }
    ...
    inline void from_json(const json & j, VectorRuntime& x) {
    ...
    inline void to_json(json & j, const VectorRuntime & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, ContentSource& x) {
        ...
        x.set_packs(j.at("packs").get<Packs>());
        x.set_schema_version(j.at("schemaVersion").get<std::string>());
        x.set_vector_runtime(j.at("vectorRuntime").get<VectorRuntime>());
    }
