...
namespace DungeonBreakContracts {
    ...
    class Option {
        ...
        private:
        VectorProfile anchor_vector;
        std::string cluster_id;
        VectorProfile effect_vector;
        std::string label;
        std::string line;
        ...
        public:
        const VectorProfile & get_anchor_vector() const { return anchor_vector; }
        VectorProfile & get_mutable_anchor_vector() { return anchor_vector; }
        void set_anchor_vector(const VectorProfile & value) { this->anchor_vector = value; }
        ...
        const VectorProfile & get_effect_vector() const { return effect_vector; }
        VectorProfile & get_mutable_effect_vector() { return effect_vector; }
        void set_effect_vector(const VectorProfile & value) { this->effect_vector = value; }
    ...
    class Cluster {
        ...
        public:
        const VectorProfile & get_center_vector() const { return center_vector; }
        VectorProfile & get_mutable_center_vector() { return center_vector; }
        void set_center_vector(const VectorProfile & value) { this->center_vector = value; }
...
namespace DungeonBreakContracts {
    ...
    inline void from_json(const json & j, Option& x) {
        x.set_anchor_vector(j.at("anchorVector").get<VectorProfile>());
        x.set_cluster_id(j.at("clusterId").get<std::string>());
        x.set_effect_vector(j.at("effectVector").get<VectorProfile>());
        x.set_label(j.at("label").get<std::string>());
    ...
    inline void from_json(const json & j, Cluster& x) {
        x.set_center_vector(j.at("centerVector").get<VectorProfile>());
        x.set_cluster_id(j.at("clusterId").get<std::string>());
