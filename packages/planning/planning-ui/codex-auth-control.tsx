...
export function CodexAuthControl() {
  ...
  const connectIfReady = useCallback(
    async (silent = false) => {
  ...
  const startBrowserLoginFlow = useCallback(
    async (loginPopup: Window | null) => {
    ...
    <div className="relative flex items-center gap-2">
      ...
      >
        {loading || busy ? (
          ...
          <SiOpenai className="size-4" aria-hidden />
        )}
      </Button>
        ...
        <div className="absolute right-0 top-10 z-50 w-[340px] rounded-lg border border-border bg-popover p-3 shadow-xl">
          ...
          {showHelp ? (
            <div className="mb-2 rounded border border-border/80 bg-muted/20 p-2 text-[11px] text-muted-foreground">
              ...
              <br />
              3. Use the chat bubble (bottom right) for Codex.
            </div>
          ) : null}
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="icon" variant="outline" asChild>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Open OpenAI login page"
                  >
